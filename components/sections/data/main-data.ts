export const quinceMainData = {
  ...
  event: {
    celebrant: "Itzi Melina",
    //Padres María de Jesús Gutiérrez y Andres Ramírez
    parents: {
      father: "Julian Carlos Mendoza Flores",
      mother: "Maritza Ortíz Morales",
    ...
    godparents: {
      godfather: "Alfonso Segura",
      godmother: "Blanca Segura",
    },
    date: {
      full: "Sábado 20 de Diciembre 2025",
      isoDate: "2025-12-20T16:00:00",
      day: "Sábado",
      dayNumber: "20",
      month: "Diciembre",
      year: "2025",
    ...
    ceremony: {
      time: "16:00 hrs.",
      venue: "Parroquia de la Santisima Trinidad",
  ...
  attendance: {
    whatsappNumber: "5214521347297", //+52 1 452 134 7297
    ...
    images: [
      {
        id: "image1",
        src: "/images/ny01.jpg",
        alt: "Itzi Melina en sus XV años",
        caption: "",
      },
      {
        id: "image2",
  ...
  customInvitations:{
    ...
    invitationUrl: "https://quince-vip-Itzi Melina.vercel.app/",
    suggested_messages: [
